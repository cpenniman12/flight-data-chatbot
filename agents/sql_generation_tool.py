"""SQL Generation Tool for generating SQL queries from natural language."""
import logging
import re
import anthropic
...
"""
    ...
    def __init__(self, client: anthropic.Anthropic):
        ...
        """
        super().__init__(
            tool_id="generate_sql",
            description="Generates SQL queries from natural language questions about flight data",
            run=self.run
        )
        self.client = client
        
    def run(self, query: str, conversation_history=None) -> Dict[str, Any]:
